...
local SCRIPTS = {
    ...
    ["AutoFARM (BETA)"]  = "https://raw.githubusercontent.com/fatehdifateh/vipffhub-script/refs/heads/main/autofarm_beta.lua",
}
...
local SCRIPTS_RAYFIELD = {
    ...
    ["Murder Mystery 2"] = "https://raw.githubusercontent.com/fatehdifateh/vipffhub-script/refs/heads/main/qatiloynu.lua",
    ["The Bronx 3"]      = "https://raw.githubusercontent.com/fatehdifateh/vipffhub-script/refs/heads/main/thbronx3.lua",
    ["AutoFARM (BETA)"]  = "https://raw.githubusercontent.com/fatehdifateh/vipffhub-script/refs/heads/main/autofarm_betaryf.lua",
}
...
local autoBtn   = makeGameBtn("AutoFARM (BETA)")
...
autoBtn.MouseButton1Click:Connect(function() selectGame("AutoFARM (BETA)") end)
    ...
    task.spawn(function()
        ...
        if valid then
            ...
            TweenService:Create(frame, TweenInfo.new(0.5, Enum.EasingStyle.Back, Enum.EasingDirection.In), {
                Position = UDim2.new(0.5, -290, -2, 0)
            }):Play()
            ...
            verifyBtn.BackgroundColor3 = Color3.fromRGB(160, 0, 0)
            for i = 1, 3 do
                TweenService:Create(frame, TweenInfo.new(0.05), {Position=UDim2.new(0.5,-280,0.5,-190)}):Play()
                task.wait(0.05)
                TweenService:Create(frame, TweenInfo.new(0.05), {Position=UDim2.new(0.5,-300,0.5,-190)}):Play()
                task.wait(0.05)
            end
            TweenService:Create(frame, TweenInfo.new(0.1), {Position=UDim2.new(0.5,-290,0.5,-190)}):Play()
        end
    end)
end)
